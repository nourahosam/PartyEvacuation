const responsestatuss = {
    ...
    "06":{
        ...
        body: {
            success: true,
            message: "Data has been saved successfully and verfication status sent to email",
            data:{}
        }
    },
    "07":{
    ...
    "13": {
        ...
        body: {
            success: true,
            message: 'Verfication status has been sent to email to rest password',
            data: {}
        }
    },
    "14": {
    ...
    "20": {
        ...
        body: {
            success: true,
            message: 'Signup Failed, email already present',
            data: {}
        }
    }
}

module.exports = responsestatuss;